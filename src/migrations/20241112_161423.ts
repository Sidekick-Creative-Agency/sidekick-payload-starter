...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_faq_block_heading_align" AS ENUM('left', 'center', 'right', 'justify');
  CREATE TYPE "public"."enum_pages_blocks_faq_block_heading_spacing_unit" AS ENUM('rem', 'px', '%');
  CREATE TYPE "public"."enum_pages_blocks_faq_block_size" AS ENUM('sm', 'md', 'lg', 'full');
  CREATE TYPE "public"."enum_pages_blocks_faq_block_padding_vertical_desktop_unit" AS ENUM('rem', 'px', '%');
  CREATE TYPE "public"."enum_pages_blocks_faq_block_padding_vertical_tablet_unit" AS ENUM('rem', 'px', '%');
  CREATE TYPE "public"."enum_pages_blocks_faq_block_padding_vertical_mobile_unit" AS ENUM('rem', 'px', '%');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_faq_block_heading_align" AS ENUM('left', 'center', 'right', 'justify');
  CREATE TYPE "public"."enum__pages_v_blocks_faq_block_heading_spacing_unit" AS ENUM('rem', 'px', '%');
  CREATE TYPE "public"."enum__pages_v_blocks_faq_block_size" AS ENUM('sm', 'md', 'lg', 'full');
  CREATE TYPE "public"."enum__pages_v_blocks_faq_block_padding_vertical_desktop_unit" AS ENUM('rem', 'px', '%');
  CREATE TYPE "public"."enum__pages_v_blocks_faq_block_padding_vertical_tablet_unit" AS ENUM('rem', 'px', '%');
  CREATE TYPE "public"."enum__pages_v_blocks_faq_block_padding_vertical_mobile_unit" AS ENUM('rem', 'px', '%');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_faq_block" (
  	...
  	"heading" varchar,
  	"heading_align" "enum_pages_blocks_faq_block_heading_align",
  	"heading_spacing_value" numeric,
  	"heading_spacing_unit" "enum_pages_blocks_faq_block_heading_spacing_unit" DEFAULT 'rem',
  	"size" "enum_pages_blocks_faq_block_size" DEFAULT 'md',
  	"padding_vertical_desktop_value" numeric DEFAULT '5',
  	"padding_vertical_desktop_unit" "enum_pages_blocks_faq_block_padding_vertical_desktop_unit" DEFAULT 'rem',
  	"padding_vertical_tablet_value" numeric DEFAULT 5,
  	"padding_vertical_tablet_unit" "enum_pages_blocks_faq_block_padding_vertical_tablet_unit" DEFAULT 'rem',
  	"padding_vertical_mobile_value" numeric DEFAULT 4,
  	"padding_vertical_mobile_unit" "enum_pages_blocks_faq_block_padding_vertical_mobile_unit" DEFAULT 'rem',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_faq_block" (
  	...
  	"enable_heading" boolean,
  	"heading" varchar,
  	"heading_align" "enum__pages_v_blocks_faq_block_heading_align",
  	"heading_spacing_value" numeric,
  	"heading_spacing_unit" "enum__pages_v_blocks_faq_block_heading_spacing_unit" DEFAULT 'rem',
  	"size" "enum__pages_v_blocks_faq_block_size" DEFAULT 'md',
  	"padding_vertical_desktop_value" numeric DEFAULT '5',
  	"padding_vertical_desktop_unit" "enum__pages_v_blocks_faq_block_padding_vertical_desktop_unit" DEFAULT 'rem',
  	"padding_vertical_tablet_value" numeric DEFAULT 5,
  	"padding_vertical_tablet_unit" "enum__pages_v_blocks_faq_block_padding_vertical_tablet_unit" DEFAULT 'rem',
  	"padding_vertical_mobile_value" numeric DEFAULT 4,
  	"padding_vertical_mobile_unit" "enum__pages_v_blocks_faq_block_padding_vertical_mobile_unit" DEFAULT 'rem',
  	"_uuid" varchar,
  	"block_name" varchar
  );
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_faq_block_heading_align";
  DROP TYPE "public"."enum_pages_blocks_faq_block_heading_spacing_unit";
  DROP TYPE "public"."enum_pages_blocks_faq_block_size";
  DROP TYPE "public"."enum_pages_blocks_faq_block_padding_vertical_desktop_unit";
  DROP TYPE "public"."enum_pages_blocks_faq_block_padding_vertical_tablet_unit";
  DROP TYPE "public"."enum_pages_blocks_faq_block_padding_vertical_mobile_unit";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_faq_block_heading_align";
  DROP TYPE "public"."enum__pages_v_blocks_faq_block_heading_spacing_unit";
  DROP TYPE "public"."enum__pages_v_blocks_faq_block_size";
  DROP TYPE "public"."enum__pages_v_blocks_faq_block_padding_vertical_desktop_unit";
  DROP TYPE "public"."enum__pages_v_blocks_faq_block_padding_vertical_tablet_unit";
  DROP TYPE "public"."enum__pages_v_blocks_faq_block_padding_vertical_mobile_unit";
